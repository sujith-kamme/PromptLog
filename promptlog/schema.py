...
class Run(BaseModel):
    ...
    def summary(self) -> dict:
        ...
        return {
            ...
            "prompt":             (self.prompt[:80] + "..." if len(self.prompt) > 80 else self.prompt) if self.prompt else None,
            "output":             (self.output[:80] + "..." if len(self.output) > 80 else self.output) if self.output else None,
